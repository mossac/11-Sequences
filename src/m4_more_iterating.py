...
def run_test_count_positive_sines():
    ...
    # Test 9:
    expected = 0
    actual = count_positive_sines([4, 5, 6])
    print()
    print('Test 1 expected:', expected)
    print('       actual:  ', actual)
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 40
    actual = sum_first_n([0, 17, 23, 5], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
